...
# option in the check (but not this manifest) to allow greater response parsing. This can be integrated later as
# situations require.
#
# Note: This require the server having nagios::server::clean or the commands manually defined.
#
# === Parameters
#
# [*namevar*]
#   The hostname will default to the name of the resource. This is the hostname that the check will send the request to.
#   This will bypass dns, but will make impacts on web servers with more than one hostname and also servers serving
...
#
# [*port*]
#   The port to check. Annoyingly, will require an override if you use https (set it to 443), as the default is 80.
#   Not required. Defaults to 80
#
# [*has_parent*]
#   Whether this http response has a parent service dependency (eg nginx, tomcat).
#   Not required. Defaults to true.
#
# [*parent_service*]
#   The name of the parent service, if has_parent is set to true (eg ${hostname}_check_nginx).
#   Required if has parent is true. Defaults to "".
#
#   Note: This is not tested.
#
# [*ssl*]
#   Boolean for whether it should use http or https. Note: You will have to change the port as well!
