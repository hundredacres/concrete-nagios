...
#
# [*nagios_parent*]
#  This is taken as a global variable from the puppet dashboard. I am not sure about the correct way of handling this.
#  This is used to override the parent in the nagios host. An important note is that nagios will fail if this is not a
#  xenhost or defined! Needs a much better solution.
#
# === Variables
#
# [*nagios_service*]
